...
<body>
  ...
  <section class="home-section">
   ...
   <h2 style="text-align: center; font-weight: bolder; color: black;">Student Record</h2>
  <table class="table">

    <!-- ALERT DELETE MESSAGE SECTION -->
    <?php  include_once 'student_process.php'; 
  ...
  if (isset($_SESSION['message'])): ?>
   ...
   <?php endif ?>
    ...
    <th  style="background-color:#080d1c;color: white;">School ID</th>
    ...
    <?php while($rows = $stmt->fetch(PDO::FETCH_ASSOC)) 
        { 
        ?> 
        <tr> <td><?php echo $rows['stu_id']; ?></td> 
        <td><?php echo $rows['name']; ?></td> 
        <td><?php echo $rows['school_name']; ?></td> 
        <td><?php echo $rows['Class']; ?></td> 
        <td>
          <a href="student_process.php?edit=<?php echo $rows['stu_id']; ?>" class="btn btn-primary">Edit</a>
          <a href="student_process.php?delete=<?php echo $rows['stu_id']; ?>" class="btn btn-danger">Delete</a>
        </td> 
        </tr> 
    <?php 
               } 
