...
<body>
  ...
  <section class="home-section">
   ...
   <h2 style="text-align: center; font-weight: bolder; color: black;">Contact Messages</h2>
  <table class="table">
  ...
  if (isset($_SESSION['message'])): ?>
   ...
   <?php endif ?>
    ...
    <th style="background-color:#080d1c; color: white;">Phone</th>
    ...
    <?php while($rows = $stmt->fetch(PDO::FETCH_ASSOC)) 
        ...
        <td>
          <a href="contact_process.php?delete=<?php echo $rows['id']; ?>" class="btn btn-danger">Delete</a>
        </td> 
        </tr> 
    <?php 
               } 
