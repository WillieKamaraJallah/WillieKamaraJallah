...
<body>
  ...
  <section class="home-section">
   ...
   <h2 style="text-align: center; font-weight: bolder; color: black;">Order List</h2>
  <table class="table">
  ...
  if (isset($_SESSION['message'])): ?>
   ...
   <?php endif ?>
    ...
    <th style="background-color:#16248c; color: white;">Category Name</th>
    <th style="background-color:#16248c; color: white;">Order By</th>
    ...
    <?php while($rows = $stmt->fetch(PDO::FETCH_ASSOC)) 
        ...
        <td>
          <a href="edit_drug.php?edit=<?php echo $rows['order_id']; ?>" class="btn btn-info">Edit</a>
          <a href="process.php?delete=<?php echo $rows['order_id']; ?>" class="btn btn-danger">Delete</a>
        </td> 
        </tr> 
    <?php 
               } 
