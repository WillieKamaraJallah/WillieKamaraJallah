...
<form action="add_school.php" method="POST" enctype="multipart/form-data">
  <h2 style="text-align: center; font-weight: bolder; color: black;">Add New School</h2>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="school_name">School Name</label>
      <input type="text" class="form-control" id="school_name" placeholder="SDA High School" name="school_name">
    </div>
    <div class="form-group col-md-6">
      <label for="address">Address</label>
      <input type="text" class="form-control" id="address" placeholder="Paynesville" name="address">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="administrator">Principal Name</label>
      <input type="text" class="form-control" id="administrator" placeholder="John Sumo" name="administrator">
    </div>
  <div class="form-row">
