...
<form action="new_product.php" method="POST" enctype="multipart/form-data">
  <h2 style="text-align: center; font-weight: bolder; color: black;">Add New Product</h2>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="name">Product Name</label>
      <input type="text" class="form-control" id="name" placeholder="Shoe" name="name">
    </div>
    <div class="form-group col-md-6">
      <label for="type">Quantity</label>
      <input type="text" class="form-control" id="quantity" placeholder="524" name="quantity">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="description">Description</label>
      <input type="texy" class="form-control" id="description" placeholder="men shoe" name="description">
    </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="price">Price</label>
      <input type="text" class="form-control" id="price" placeholder="$ 30.00" name="price">
    </div>
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="discount">Discount</label>
      <input type="text" class="form-control" id="price" placeholder="$ 25.00" name="discount">
    </div>
