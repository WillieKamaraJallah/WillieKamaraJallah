...
<form action="add_student.php" method="POST" enctype="multipart/form-data">
  <h2 style="text-align: center; font-weight: bolder; color: black;">Add New Student</h2>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="name">Student Name</label>
      <input type="text" class="form-control" id="name" placeholder="Alex Desoe" name="name">
    </div>
    <div class="form-group col-md-6">
      <label for="school_name">School Name</label>
      <input type="text" class="form-control" id="school_name" placeholder="Adventist High School" name="school_name">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="class">Student Class</label>
      <input type="text" class="form-control" id="class" placeholder="4 Grade" name="class">
    </div>
  <div class="form-row">
