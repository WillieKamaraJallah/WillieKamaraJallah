...
<body>
  ...
  <table class="table">
    ...
    <?php  include_once 'edit_product.php'; 
  ...
  if (isset($_SESSION['message'])): ?>
   ...
   <?php endif ?>
    ...
    <th style="background-color:#16248c; color: white;">Product Name</th>
    <th style="background-color:#16248c; color: white;">Quantity</th>
    <th style="background-color:#16248c; color: white;">Description</th>
    <th style="background-color:#16248c; color: white;">Price</th>
    <th style="background-color:#16248c; color: white;">Discount</th>
    <th style="background-color:#16248c; color: white;">Date Upload</th>
    <th colspan="2" style="background-color:#16248c; color:white;">Action</th>
    <tr>
    <?php while($rows = $stmt->fetch(PDO::FETCH_ASSOC)) 
        { 
        ?> 
        <tr> <td><?php echo $rows['pr_id']; ?></td> 
        ...
        <td>
          <a href="edit_product.php?edit=<?php echo $rows['pr_id']; ?>" class="btn btn-info">Edit</a>
          <a href="edit_product.php?delete=<?php echo $rows['pr_id']; ?>" class="btn btn-danger">Delete</a>
        </td> 
        </tr> 
    <?php 
               } 
